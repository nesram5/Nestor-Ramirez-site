...
function repartir_mesa() {
  let copia_carta_dup, dup, index_carta_dup, newlist, replace_carta, valor_replace_carta;
...
function elegir_repartidor() {
  let aux, baraja_repartidor, baraja_repartidor_valor, carta_alta, copy_baraja_repartidor_valor, id_ganador, index, list_id, list_id2, num_carta, opcion;
  baraja_repartidor = [];
...
function turno_cpu(cpuid) {
  let caida, index, jug2_valor, jug3_valor, jug4_valor, pts;
...
function ronda_vigia_tribilin(cartas_jug_valor, turno_id) {
  let canto, index_carta_canto, nombre_canto, pts_canto, valor_carta_canto, valor_carta_canto_mas, valor_carta_canto_menos;
  pts_canto = 0;
  canto = [0, 0, 0, 0];
...
function patrulla(cartas_jug_valor, turno_id) {
  let canto, carta_0, carta_1, carta_2, nombre_canto, pts_canto;
  pts_canto = 0;
  canto = [0, 0, 0, 0];
  cartas_jug_valor.sort();
...
function registro(cartas_jug_valor, turno_id) {
  let canto, nombre_canto, pts_canto;
  pts_canto = 0;
  canto = [0, 0, 0, 0];
  cartas_jug_valor.sort();
...
function canto_mayor(repartidor) {
  let dup, id_ganador, max_pts, max_sumvalor, newlist, nombre_canto, orden_id, orden_nombre_canto, orden_pts, orden_sumvalor, pts, rep;
...
function echar_mesa(repartidor) {
  let escoger_cpu, opcion, pts, repartidor2;
  pts = 0;
  escoger_cpu = [1, 4];
